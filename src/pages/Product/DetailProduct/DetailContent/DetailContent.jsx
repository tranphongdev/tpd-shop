            ...
            <div className="flex lg:flex-row flex-col gap-5 items-start">
                ...
                <div className="lg:w-1/2 w-full">
                    ...
                    <div className="flex items-center gap-5 mb-[30px]">
                        <button className="flex items-center gap-2 transition-colors hover:bg-primary hover:text-white capitalize justify-center py-[10px] px-[15px] text-[16px] font-light min-w-[198px] border border-gray">
